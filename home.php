...
<div class="wrapper">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu">
                                <a href="javascript:void(0);">Weight Class 1</a>

                            </li>
                            <li class="dropdown-submenu">
                                <a href="javascript:void(0);">Weight Class 2</a>

                            </li>
                            <li class="dropdown-submenu">
                                <a href="javascript:void(0);">Weight Class 3</a>

                            </li>
                            <li class="dropdown-submenu">
                                <a href="javascript:void(0);">Weight Class 4</a>

                            </li>
                            <li class="dropdown-submenu">
                                <a href="javascript:void(0);">Weight class 5</a>
    ...
    <div id="layerslider" style="width: 100%; height: 500px; margin: 0px auto;">
        ...
        <div class="ls-slide" data-ls="slidedelay:4500;transition2d:25;">
            <img src="images/LOgO_4.png" class="ls-bg" alt="Slide background"/>
            <i class="fa fa-chevron-circle-right ls-s-1" style=" color: black; font-size: 24px; top:70px; left: 40px; "></i>

            <span class="ls-s-2" style=" color: black; font-weight: 200; font-size: 22px; top:70px; left: 70px; ">
                Welcome To Fantasy Fight League
            </span>

            <i class="fa fa-chevron-circle-right ls-s-1" style=" color: black; font-size: 24px; top:120px; left: 40px; "></i>

            <span class="ls-s-2" style=" color: black; font-weight: 200; font-size: 22px; top:120px; left: 70px; ">
                Your Number 1 Friend Based Fantasy Prediction site
            </span>
			
			<i class="fa fa-chevron-circle-right ls-s-1" style=" color: black; font-size: 24px; top:170px; left: 40px; "></i>
			
			<span class="ls-s-2" style=" color: black; font-weight: 200; font-size: 22px; top:170px; left: 70px; ">
                Join The Fun by Creating Your Free Account now
            </span>

           

            <a class="btn-u btn-u-blue ls-s1" href="#" style=" padding: 9px 20px; font-size:25px; top:210px; left: 40px;  ">
                Create Account
            </a>			
